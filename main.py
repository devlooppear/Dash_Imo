...
for caminho in caminhos:
    ...
    for nome,a,b,c,d,e,f,d in list(zip(caminhos,titulos_liq_dia,titulos_ult_rend,titulos_div_yield,titulos_pat_liq,titulos_pat,titulos_ren_mes,titulos_p_vp)):
        ...
        sql = f'''INSERT INTO imobiliaria (nomes_cam,liq_dia,ult_rend,div_yield,pat_liq,vlr_pat,ren_mes,p_vp) VALUES ('{nome}','{int(a)}','{float(b)}','{float(c)}','{int(d)}','{float(e)}','{float(f)}','{float(g)}')'''
        cursor.execute(sql)
